...
execute as @e[name=qr_read,tag=qr_read_more] at @s if block ~~~ minecraft:air [] run summon minecraft:armor_stand qr_read_sub ~~~4
execute as @e[name=qr_read,tag=qr_read_more] at @s if block ~~~ minecraft:air [] run setblock ~~~ minecraft:diamond_block
execute as @e[name=qr_read,tag=qr_read_more] at @s if block ~~~ minecraft:diamond_block [] if entity @e[name=qr_read_sub,scores={qr_split=2}] run tag @s remove qr_read_more
