...
scoreboard players set "a2" pn_a 10000
scoreboard players set "a3" pn_a 1000
scoreboard players set "a4" pn_a 2
scoreboard players set "a5" pn_a 900
scoreboard players set "a6" pn_a 60
scoreboard players set "a7" pn_a 55
scoreboard players set "a8" pn_a -1
scoreboard players set "a9" pn_a 28
scoreboard players set "a10" pn_a 160
...
execute as @e[name=pn_set,tag=pn_set2,tag=pn_set4,scores={pn_gra_x=0}] at @s run tp @s ~~~24
...
execute as @e[name=pn_set,tag=pn_set2,scores={pn_gra_x=1..,pn_a=0}] at @s run tp @s ~24~~
execute as @e[name=pn_set,tag=pn_set2,scores={pn_gra_x=1..,pn_a=1}] at @s run tp @s ~-24~~
...
execute as @e[name=pn_set,tag=pn_set3] at @s run summon minecraft:armor_stand pn_p ~23 ~ ~
execute as @e[name=pn_set,tag=pn_set3] at @s run summon minecraft:armor_stand pn_p ~ ~ ~23
execute as @e[name=pn_set,tag=pn_set3] at @s run summon minecraft:armor_stand pn_p ~23 ~ ~23
...
execute as @e[tag=pn_p1] at @s positioned ~23 ~ ~ run tag @e[c=1,r=0.5,type=minecraft:armor_stand,name=pn_p] add pn_p2
execute as @e[tag=pn_p1] at @s positioned ~23 ~ ~23 run tag @e[c=1,r=0.5,type=minecraft:armor_stand,name=pn_p] add pn_p3
execute as @e[tag=pn_p1] at @s positioned ~ ~ ~23 run tag @e[c=1,r=0.5,type=minecraft:armor_stand,name=pn_p] add pn_p4

##梯度向量
scoreboard players random @e[tag=pn_p,tag=!pn_ran] pn_random 0 24
...
execute as @e[tag=pn_p,tag=!pn_ran] run scoreboard players set @s pn_gra_z 576
...
kill @e[name=pn_pmx,scores={pn_x=240..}]
#
...
kill @e[name=pn_pmz,scores={pn_z=240..}]

##点积计算
function random_terrain/PerlinNoise_normal/value
function random_terrain/PerlinNoise_normal/value
function random_terrain/PerlinNoise_normal/value
...
effect @e[name=pn_pm] invisibility 1 1 true
#By Baby_2016